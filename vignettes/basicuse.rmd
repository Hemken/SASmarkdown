...
knitr::opts_chunk$set(engine.path=list(sas=saspath, sashtml=saspath, saslog=saspath, sashtmllog=saspath),
                      engine.opts=list(sas=sasopts, sashtml=sasopts, saslog=sasopts, sashtmllog=sasopts),
                      comment=NA)
